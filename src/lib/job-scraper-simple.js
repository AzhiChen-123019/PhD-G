...
// 使用纯CommonJS语法，避免模块解析问题

const mongoose = require('mongoose');

// 连接到MongoDB数据库
const MONGODB_URI = process.env.MONGODB_URI || 'mongodb+srv://18223402922_db_user:55Yj0CQhFwoZ5fze@job-platform-cluster.7c8krno.mongodb.net/?appName=job-platform-cluster';

// 定义岗位标签子文档结构
const jobTagSchema = new mongoose.Schema({
  category: {
    type: String,
    enum: ['university', 'enterprise'],
    required: true
  },
  subType: {
    type: String,
...
// 导出函数供其他模块使用
module.exports = { scrapeJobs, saveJobsToDatabase, classifyJobType };
