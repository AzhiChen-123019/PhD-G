            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              ...
              <div className="bg-white rounded-lg shadow p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-2xl font-semibold text-gray-900">{dashboardData.todayNewUsers}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <h3 className="text-sm font-medium text-gray-500">个人用户</h3>
                    <p className="text-2xl font-semibold text-gray-900">{dashboardData.personalUsers}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <h3 className="text-sm font-medium text-gray-500">企业用户</h3>
                    <p className="text-2xl font-semibold text-gray-900">{dashboardData.enterpriseUsers}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-2xl font-semibold text-gray-900">{dashboardData.totalFiles}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-2xl font-semibold text-gray-900">{dashboardData.emailSent}</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        向用户发送邀请邮件：john.doe@example.com
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-green-600">
                        成功
                      </td>
